...
SIGNAL \dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\ : std_logic;
SIGNAL \shift_reg~3_combout\ : std_logic;
SIGNAL \datau[4]~10_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\ : std_logic;
SIGNAL \datau[3]~11_combout\ : std_logic;
SIGNAL \datau[3]~9_combout\ : std_logic;
SIGNAL \datau[0]~4_combout\ : std_logic;
SIGNAL \datau[2]~6_combout\ : std_logic;
SIGNAL \datau[2]~7_combout\ : std_logic;
SIGNAL \datau[2]~8_combout\ : std_logic;
...
SIGNAL \dut_input[5]~feeder_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\ : std_logic;
SIGNAL \datau[2]~2_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|OR1|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \dut_instance|add_instance|OR1|Y~0_combout\,
	devoe => ww_devoe,
	o => ww_state_out(0));
...
-- Equation(s):
-- \shift_reg~0_combout\ = (!\io~q\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\))
...
-- Equation(s):
-- \shift_reg~1_combout\ = (\io~q\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\))
...
\dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\ = dut_input(5) $ (dut_input(1) $ (((dut_input(0) & dut_input(4)))))
...
PORT MAP (
	...
	datac => dut_input(0),
	datad => dut_input(4),
	combout => \dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\);
...
\datau[4]~10\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[4]~10_combout\ = (\shift_reg~1_combout\ & (((\dut_instance|add_instance|OR1|Y~0_combout\)))) # (!\shift_reg~1_combout\ & (!\shift_reg~3_combout\ & ((datau(4)))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|OR1|Y~0_combout\,
	datac => datau(4),
...
\dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\ = (\dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\ & ((dut_input(2)) # (dut_input(6)))) # (!\dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\ & 
-- (dut_input(2) & dut_input(6)))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\,
	datac => dut_input(2),
	datad => dut_input(6),
	combout => \dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\);
...
\datau[3]~11\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[3]~11_combout\ = (\datau[2]~2_combout\ & (\dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\ $ (((dut_input(7)))))) # (!\datau[2]~2_combout\ & ((\dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\ & 
-- ((dut_input(7)))) # (!\dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\ & (dut_input(3) & !dut_input(7)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \datau[2]~2_combout\,
	datab => \dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\,
	datac => dut_input(3),
	datad => dut_input(7),
	combout => \datau[3]~11_combout\);

-- Location: LCCOMB_X38_Y25_N28
\datau[3]~9\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[3]~9_combout\ = (\shift_reg~1_combout\ & (dut_input(3) $ (((\datau[3]~11_combout\))))) # (!\shift_reg~1_combout\ & (((datau(4)))))
...
-- Equation(s):
-- \datau[0]~4_combout\ = (\io~q\ & ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\))) # 
...
\datau[2]~6\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[2]~6_combout\ = \dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\ $ (dut_input(2) $ (dut_input(6)))
...
\datau[2]~7\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[2]~7_combout\ = (\dut_instance|add_instance|OR1|Y~0_combout\ & ((\datau[2]~2_combout\) # ((\dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\ & \datau[2]~6_combout\)))) # (!\dut_instance|add_instance|OR1|Y~0_combout\ & 
-- (((\datau[2]~6_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\,
	datab => \datau[2]~2_combout\,
	datac => \dut_instance|add_instance|OR1|Y~0_combout\,
	datad => \datau[2]~6_combout\,
	combout => \datau[2]~7_combout\);

-- Location: LCCOMB_X38_Y25_N18
\datau[2]~8\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[2]~8_combout\ = (\shift_reg~1_combout\ & ((\datau[2]~7_combout\))) # (!\shift_reg~1_combout\ & (datau(3)))
...
PORT MAP (
	datab => datau(3),
	datac => \datau[2]~7_combout\,
	datad => \shift_reg~1_combout\,
	combout => \datau[2]~8_combout\);
...
-- Equation(s):
-- \datau[1]~5_combout\ = (\shift_reg~1_combout\ & (\dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\ $ ((\dut_instance|add_instance|OR1|Y~0_combout\)))) # (!\shift_reg~1_combout\ & (((datau(2)))))
...
-- Equation(s):
-- \datau[0]~3_combout\ = (\shift_reg~1_combout\ & (dut_input(4) $ ((dut_input(0))))) # (!\shift_reg~1_combout\ & (((datau(1)))))
...
\dut_input[5]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_input[5]~feeder_combout\ = data(5)
...
PORT MAP (
	datad => data(5),
	combout => \dut_input[5]~feeder_combout\);
...
\dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\ = (dut_input(5) & ((dut_input(1)) # ((dut_input(0) & dut_input(4))))) # (!dut_input(5) & (dut_input(0) & (dut_input(1) & dut_input(4))))
...
PORT MAP (
	...
	datac => dut_input(1),
	datad => dut_input(4),
	combout => \dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\);

-- Location: LCCOMB_X37_Y25_N18
\datau[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[2]~2_combout\ = (!\dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\ & (\dut_instance|add_instance|FourbitAdder1|fulladder1|OR1|Y~0_combout\ $ (dut_input(2) $ (!dut_input(6)))))
...
PORT MAP (
	...
	datab => dut_input(2),
	datac => dut_input(6),
	datad => \dut_instance|add_instance|FourbitAdder1|fulladder1|Half_adder2|S~0_combout\,
	combout => \datau[2]~2_combout\);

-- Location: LCCOMB_X37_Y25_N0
\dut_instance|add_instance|OR1|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|OR1|Y~0_combout\ = (\datau[2]~2_combout\ & ((\dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\ & ((dut_input(7)) # (dut_input(3)))) # (!\dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\ & 
-- (dut_input(7) & dut_input(3))))) # (!\datau[2]~2_combout\ & ((\dut_instance|add_instance|FourbitAdder1|fulladder2|OR1|Y~0_combout\) # ((dut_input(7)) # (dut_input(3)))))
...
PORT MAP (
	...
	datac => dut_input(7),
	datad => dut_input(3),
	combout => \dut_instance|add_instance|OR1|Y~0_combout\);
